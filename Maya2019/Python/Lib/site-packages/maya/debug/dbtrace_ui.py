...
#======================================================================
#
#   Show a window containing the dbtrace output, with highlighting
...
def dbtrace_show_output(trace_object, output_file):
    ...
    scrollableMessageBox(
        title=maya.stringTable['y_dbtrace_ui.kDbTraceOutputTitle' ].format( trace_object, output_file)
    ,   messageCallback=partial(get_dbtrace_output, output_file=output_file)
    )
