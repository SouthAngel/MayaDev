...
class dirtyState(object):
    ...
    def __str__(self):
        ...
        '''
        result = {}
        result['configuration'] = { 'Use Long Names'    : self.use_long_names
                                  , 'Check Plugs'       : self.check_plugs
                                  , 'Check Data'        : self.check_data
                                  , 'Check Connections' : self.check_connections
                                  }
        result['plugs'] = self.plugs
