...
class PyDepGraphItr(MayaToPyItr):
    ...
    """
    def _item(self):
        # MItDependencyGraph supports currentItem, but not thisNode
        #
        return om.MFnDependencyNode( self._maya_iterator.currentItem() )
...
class PyDepNodesItr(PyDepGraphItr):
    ...
    def _item(self):
        # use thisNode method because MItDependencyNodes supports it,
        # but not currentItem
        #
