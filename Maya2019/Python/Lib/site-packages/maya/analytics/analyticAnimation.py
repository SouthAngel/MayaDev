...
kAnalyticLabel = maya.stringTable['y_analyticAnimation.kAnalyticLabel' ]
kAnalyticDescriptionShort = maya.stringTable['y_analyticAnimation.kAnalyticDescriptionShort' ]
...
class analyticAnimation(BaseAnalytic):
    ...
    def __is_zero(cls,potentialZero):
        ...
        :param potentialZero: Value that might be zero
        :return: True if the value is without tolerance of zero (0.001)
        """
        return abs(potentialZero) <= cls.ZERO_TOLERANCE
    ...
    def __is_really_animated(cls,the_curve):
        ...
        :param the_curve: Anim curve to check
        :return: True if the curve does vary
        """
        try:
