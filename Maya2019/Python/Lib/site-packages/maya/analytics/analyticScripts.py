...
kAnalyticLabel = maya.stringTable['y_analyticScripts.kAnalyticLabel' ]
kAnalyticDescriptionShort = maya.stringTable['y_analyticScripts.kAnalyticDescriptionShort' ]
...
class analyticScripts(BaseAnalytic):
    ...
    def __checkExists(self, jobArgs, shortName, longName):
        ...
        :param jobArgs:   Arguments to the script job being checked
        :param shortName: Short name of the flag to look for
        :param longName:  Long name of the flag to look for
    ...
    def __reportExists(self, name):
        ...
        :param name: Flag name whose existence is reported
        """
    ...
    def __reportFlag(self, name):
        ...
        See that method for a description of how the data was collected.
        :param name: Flag name to report
        """
        if hasattr(self, name):
