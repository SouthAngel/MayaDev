"""
Analyze the usage modes of the tweak node.
"""
import maya
...
kAnalyticLabel = maya.stringTable['y_analyticGPUTweaks.kAnalyticLabel' ]
kAnalyticDescriptionShort = maya.stringTable['y_analyticGPUTweaks.kAnalyticDescriptionShort' ]
...
class analyticGPUTweaks(BaseAnalytic):
    ...
    def run(self):
        ...
        if not tweak_nodes:
            return { 'warning' : 'No GPU tweaks to examine' }
