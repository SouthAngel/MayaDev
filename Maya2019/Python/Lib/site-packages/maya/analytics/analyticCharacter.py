"""
Analyze the characters in the scene.
"""
import maya
...
kAnalyticLabel = maya.stringTable['y_analyticCharacter.kAnalyticLabel' ]
kAnalyticDescriptionShort = maya.stringTable['y_analyticCharacter.kAnalyticDescriptionShort' ]
