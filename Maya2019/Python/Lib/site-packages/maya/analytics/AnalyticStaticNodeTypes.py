"""
Examine node type distribution common to all scenes.
"""
import maya
...
kAnalyticLabel = maya.stringTable['y_AnalyticStaticNodeTypes.kAnalyticLabel' ]
kAnalyticDescriptionShort = maya.stringTable['y_AnalyticStaticNodeTypes.kAnalyticDescriptionShort' ]
...
class AnalyticStaticNodeTypes(BaseAnalytic):
    ...
    def __get_json(self, root_node_type):
        ...
        :param root_node_type: Node type to start from
        :return: JSON with the node type information from the root_node_type down
        """
