"""
Scene stats collection for node types.
"""
import maya
...
kAnalyticLabel = maya.stringTable['y_analyticNodeTypes.kAnalyticLabel' ]
kAnalyticDescriptionShort = maya.stringTable['y_analyticNodeTypes.kAnalyticDescriptionShort' ]
...
class analyticNodeTypes(BaseAnalytic):
    ...
    def __is_node_counted(self, node_name):
        ...
        :param node_name: Name of node to check for counting
        :return: True if the node should be counted.
        """
    ...
    def __find_leaf( self, hierarchy_below, parent_dict ):
        ...
        :param hierarchy_below: List of parent types of the desired node type,
                                from root to leaf inclusive, in that order.
        :param parent_dict:     Reference to the value on the parent node's key,

        :return: The leaf node is a key in a dictionary, return a reference to its value.
        """
