"""
Analyze the usage modes of deformer nodes.
"""
import maya
...
kAnalyticLabel = maya.stringTable['y_analyticGPUDeformers.kAnalyticLabel' ]
kAnalyticDescriptionShort = maya.stringTable['y_analyticGPUDeformers.kAnalyticDescriptionShort' ]
...
class analyticGPUDeformers(BaseAnalytic):
    ...
    def __deformer_types( ):
        """
        :return: List of known deformer types
        """
        deformer_types = [
            "baseLattice" ,
            "blendShape" ,
