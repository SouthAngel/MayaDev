...
kAnalyticLabel = maya.stringTable['y_analyticEvalManager.kAnalyticLabel' ]
kAnalyticDescriptionShort = maya.stringTable['y_analyticEvalManager.kAnalyticDescriptionShort' ]
...
class analyticEvalManager(BaseAnalytic):
    ...
    def __gather_summary_data(self, raw_json):
        ...
        :param raw_json: Dictionary containing all of the eval manager data for a node
