...
def resetAllManipulations (nodeName):
    charManipulations = cmds.getAttr(nodeName+'.manipulatorPositionsPP' )
    wordManipulations = cmds.getAttr(nodeName+'.manipulatorWordPositionsPP')
    lineManipulations = cmds.getAttr(nodeName+'.manipulatorLinePositionsPP' )

    currentChar = cmds.getAttr(nodeName+'.manipulateId')
    currentWord = cmds.getAttr(nodeName+'.manipulateWord')
    currentLine = cmds.getAttr(nodeName+'.manipulateLine')
    ...
    cmds.setAttr(nodeName+'.manipulatorPositionsPP', charManipulations, type="vectorArray" )
    cmds.setAttr(nodeName+'.manipulatorWordPositionsPP', wordManipulations, type="vectorArray" )
    cmds.setAttr(nodeName+'.manipulatorLinePositionsPP', lineManipulations, type="vectorArray" )

    cmds.setAttr(nodeName+'.manipulatorRotationsPP', charManipulations, type="vectorArray" )
    cmds.setAttr(nodeName+'.manipulatorWordRotationsPP', wordManipulations, type="vectorArray" )
    cmds.setAttr(nodeName+'.manipulatorLineRotationsPP', lineManipulations, type="vectorArray" )

    cmds.setAttr(nodeName+'.manipulatorScalesPP', charManipulations, type="vectorArray" )
    cmds.setAttr(nodeName+'.manipulatorWordScalesPP', wordManipulations, type="vectorArray" )
    cmds.setAttr(nodeName+'.manipulatorLineScalesPP', lineManipulations, type="vectorArray" )
