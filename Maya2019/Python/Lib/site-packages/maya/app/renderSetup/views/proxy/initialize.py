...
_entries = {
    ...
    conOvModel.ConnectionUniqueOverride.kTypeName: rs.ConnectionUniqueOverrideProxy,
    ...
    colModel.RenderSettingsChildCollection.kTypeName: rs.RenderSettingsChildCollectionProxy,
