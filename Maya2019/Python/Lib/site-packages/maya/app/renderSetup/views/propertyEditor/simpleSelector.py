...
class SimpleSelector(object):
    ...
    def selectIncludeExpression(self):
        commonUtils.echoSelect(list(self._selector.getDynamicNames()), add=False, noExpand=True)
      
    def selectStaticEntries(self):
        self.staticSelector.selectMembers()
        commonUtils.echoSelect(list(self._selector.getStaticNames()), add=False, noExpand=True)
