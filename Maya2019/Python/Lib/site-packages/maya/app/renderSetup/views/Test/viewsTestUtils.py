...
class ViewRenderSetupTest(Test.RenderSetupTest):
    ...
    def setUpClass(cls):
        ...
        # just for our test.
        import maya.app.renderSetup.common.test.sceneUtils as sceneUtils
    ...
    def setUp(self):
        ...
        # See comments in views.renderSetup.renderSetupWindowDestroyed.
        # The destroyed callback sets the views.renderSetup.selectionObserver
        # back to None, but this callback occur asynchronously, after the
        # window is closed.  Therefore, selectionObserver is not None when we
        # call createUI() above, and the selectionObserver is not connected to
        # the new Qt selection model.  Do so explicitly here.
        renderSetupUI.selectionObserver.reinitialize(
            renderSetupUI.renderSetupWindow.centralWidget.renderSetupView.selectionModel())
        cmds.flushIdleQueue()
