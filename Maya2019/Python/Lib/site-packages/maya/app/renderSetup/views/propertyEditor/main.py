...
class PropertyEditor(MayaQWidgetDockableMixin, QWidget):
    ...
    def __init__(self, treeView, parent, observeRenderSetup=True):
        ...
        if observeRenderSetup:
            self.setWindowTitle(maya.stringTable['y_main.kPropertyEditorRenderSetup' ])
        else:
            self.setWindowTitle(maya.stringTable['y_main.kPropertyEditorLightEditor' ])
    ...
    def _addCollection(self, currentItem):
        ...
        self._addItemEditor(collectionFactory.create(currentItem, self))
