...
"""
The code in this file is used to specify a frame layout in PySide2 and is a modified version of the public domain code taken from: http://pastebin.com/qYgDDYsB
