...
def rebuild():
	...
	excludedLightTypes.append("aiFog")					# Exclude aiFog since it's not a proper light source
	excludedLightTypes.append("aiAtmosphereVolume")	# Exclude aiAtmosphereVolume since it's not a real light source
