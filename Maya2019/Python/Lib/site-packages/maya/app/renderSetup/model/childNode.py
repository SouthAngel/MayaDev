...
from maya.app.renderSetup.model.labelColor import LabelColor
...
class ChildNode(Observable, NodeNotes, SerializableNode, LabelColor, nodeList.ListItem):
    ...
    def _encodeProperties(self, dict):
        NodeNotes._encodeProperties(self, dict)
        if jsonTranslatorGlobals.exportLabelColorEnabled() or jsonTranslatorGlobals.copyPasteLabelColorEnabled():
            LabelColor._encodeProperties(self, dict)
        # Do not export the 'import status'

    def _decodeProperties(self, dict, mergeType, prependToName):
        NodeNotes._decodeProperties(self, dict, mergeType, prependToName)
        if jsonTranslatorGlobals.importLabelColorEnabled() or jsonTranslatorGlobals.copyPasteLabelColorEnabled():
            LabelColor._decodeProperties(self, dict, mergeType, prependToName)
