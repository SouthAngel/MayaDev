...
connectionUniqueOverride      = OpenMaya.MTypeId(0x580003A2)
renderSettingsChildCollection = OpenMaya.MTypeId(0x580003A3)
lightsCollectionSelector      = OpenMaya.MTypeId(0x580003A4)
upperBound                    = lightsCollectionSelector.id() + 1

# We keep light editor nodes in a seperate range 0x580003E0 to 0x580003FF
# with the intention of moving them out from this file at some point.
lightItemBase                 = OpenMaya.MTypeId(0x580003E0)
lightItem                     = OpenMaya.MTypeId(0x580003E1)
lightGroup                    = OpenMaya.MTypeId(0x580003E2)
lightEditor                   = OpenMaya.MTypeId(0x580003E3)
...
def isRenderSetupType(typeID):
    ...
    '''
    return typeID.id() >= 0x58000370 and typeID.id() < 0x580003E0
# ===========================================================================
