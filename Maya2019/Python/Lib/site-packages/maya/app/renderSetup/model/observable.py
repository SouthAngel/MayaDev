...
import maya.app.renderSetup.model.weakMethod as weakMethod
...
class Observable(object):
    ...
    def nbObservers(self):
        # Unfortunately, trying to name this method __len__ causes render
        # layer test failures, most likely because of multiple inheritance
        # from this class, and the use of __len__() in a boolean context.
        return len(self._itemObservers)
