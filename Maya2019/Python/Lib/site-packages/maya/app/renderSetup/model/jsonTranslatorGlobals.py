...
# Color Options
REJECT_COLOR    = 0  # Reject label colors via import or export (checkbox unchecked)
ACCEPT_COLOR	= 1  # Accept label colors via import or export (checkbox checked)
...
_enableExportLabelColor = True # Notifies encoding methods whether or not we want to export label color in json
_enableImportLabelColor = True # Notifies decoding methods whether or not we want to import label colors from json
_copyPasteColor = False # Notifies encode and decode methods to encode/decode label color on copy/paste

def enableCopyPasteLabelColor(value):
    global _copyPasteColor
    _copyPasteColor = value

def copyPasteLabelColorEnabled():
    return _copyPasteColor

def enableExportLabelColor(value):
	global _enableExportLabelColor
	_enableExportLabelColor = value

def exportLabelColorEnabled():
    return _enableExportLabelColor 

def enableImportLabelColor(value):
    global _enableImportLabelColor
    _enableImportLabelColor = value

def importLabelColorEnabled():
    return _enableImportLabelColor
